...
class TodoCreationTest(APITestCase):
    def setUp(self):
        ...
        self.client.credentials(HTTP_AUTHORIZATION="Bearer " + response.data.get("tokens").get("access"))
    ...
    def test_create_todo_duplicate_title(self):
        self.client.post(self.url, {"title": "unique-title"}, content_type='application/json')
...
class todoUpdateTest(APITestCase):
    def setUp(self):
        ...
        response=self.client.post(reverse("list_create_tasks"),data=self.payload,content_type='application/json')
    ...
    def test_update_todo(self):
        ...
        response=self.client.put(self.url,data=self.payload,content_type='application/json')
    ...
    def test_partial_update_todo(self):
        ...
        response = self.client.put(self.url, data=partial_payload, content_type='application/json')
